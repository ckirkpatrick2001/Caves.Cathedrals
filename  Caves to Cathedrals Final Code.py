...
# ----------------------------------------------------------
# To run this game, Press the run tab on the top of your screen,
# the click "run module". For the best experience, put this
# window in full screen 
# ----------------------------------------------------------
# Name:Chase Kirkpatrick
# ----------------------------------------------------------

print('''INSTRUCTIONS: When prompted to enter something [this/that], make sure that you enter it exactly as it is displayed on screen.
...
print("\nWelcome, " + username + ''', to a choose your own adventure game. This game will allow you to travel down a
...
are based on true events that we have either learned about in class or are similar.\n''')

direction0 = input("The Medieval ages were difficult and dangerous times. Are you ready to begin? [yes/no] ")
if direction0 == "yes" :
    print("\nLet us begin.")
if direction0 == "no" :
    print("\nIf you are not ready, why are you here? Although I must say, it is already too late. Let us begin.\n")
...
You realize that you are low on money and that the idea of becoming rich doesn't seem like a terrible option. However, you're not entirely sure if you want to go.''')
#Crusade
    direction2 = input("Do you decide to join these crusaders on their journey or do you continue south to France? [Crusade/France] ")
...
ransack much of the city.You decide to take part too.''')
            input()
            print('''You aquire many treasures and gold. You discover that many of the religious places of worship contain priceless artifacts. As a result, you steal as many as you can.
...
#Cathedral
    print('''\nYou arrive in France and see the new Beauvais Cathedral being built. It is nothing like you have seen before: it was much higher and grander than any building.
...
marvel. With your newly acquired wealth, you decide to settle down here for a while.''')
    input()
...
Yet the cathedral has such captivating beauty that you want to see it any opportunity that you get. Still, you feel like something is wrong and you shouldn't go.''')
...
and start yelling that the relic is fake. Soon enough, you have a large group of people surrounding you listening. Yet no one seems to be doing anything. Then you hear a voice yell
...
cell. The Bishop knows if you ever get out, it would be the death of the town.\n\n[GAME OVER]''')
            ...
            print('''\nYou decide not to go on this pilgrimage and stay home. You settle down and find work but you can't shake the feeling that you are missing something in your life.
